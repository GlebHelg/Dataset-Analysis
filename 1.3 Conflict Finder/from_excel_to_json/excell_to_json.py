...
# No reason to use main, since this code won't be imported as a module # 

#Command Line Argument Parser
parser = argparse.ArgumentParser(description = "Specify input-/output- file/s")
parser.add_argument(  '-i', default='pakker_excell.xlsx')
parser.add_argument(  '-o', default='pakker_json.json')
args = parser.parse_args()

if not os.path.isfile(args.i):
    print "No input-file in directory named: ", args.i
    sys.exit()

#Opening Excel file for globale
wb = load_workbook(args.i)
